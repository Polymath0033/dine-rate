...
export const Restaurant: React.FC = () => {
  ...
  return (
    <Fragment>
      <div className="background  flex flex-col w-full h-screen py-[30px] pl-[104px] pb-28 ">
        ...
        <div className="flex flex-col justify-center h-[800px] items-center w-[750px] mx-auto mt-20  ">
          ...
          <h1 className="font-bold text-5xl text-black mt-2 ">
            Discover Honest, Blockchain-Verified Restaurant Reviews{" "}
          </h1>
          <p className="text-xl text-center text-black mt-7 ">
      ...
      <div className="down-background  flex flex-col w-full h-screen py-[30px] pl-[104px]">
        ...
        <ul className="inline-flex flex-wrap gap-8 items-center">
